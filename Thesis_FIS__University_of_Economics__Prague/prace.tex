...
\def\NazevPrace{GPU-Accelerated Action Rule Mining with a Deep Learning Framework}

% Typ práce
\def\TypPrace{BACHELOR'S THESIS}
%\def\TypPrace{DIPLOMOVÁ PRÁCE}


% Jméno autora
\def\AutorPrace{Jan Hrdonka}

% Rok odevzdání. měsíc (slovně)
\def\DatumOdevzdani{May 2026}

% Vedoucí práce: Jméno a příjmení s~tituly
\def\Vedouci{Ing. Lukáš Sýkora, Ph.D.}
...
\def\Prohlaseni{TODO
Prohlašuji, že jsem bakalářskou práci \textit{\NazevPrace} vypracoval samostatně za použití v práci uvedených pramenů a literatury.}
